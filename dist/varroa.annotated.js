...
angular.module('varroa', ['ui.router', 'infinite-scroll', 'angularMoment', 'varroa.upload', 'varroa.tile', 'angulartics.google.analytics']).constant('_', window._).config(["$stateProvider", "$urlRouterProvider", function ($stateProvider, $urlRouterProvider) {
