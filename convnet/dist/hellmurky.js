...
/***/ function(module, exports, __webpack_require__) {
	...
	net.makeLayers([{ type: 'input', out_sx: 32, out_sy: 32, out_depth: 3 }, { type: 'conv', sx: 5, filters: 16, stride: 1, pad: 2, activation: 'relu' }, { type: 'pool', sx: 2, stride: 2 }, { type: 'conv', sx: 5, filters: 20, stride: 1, pad: 2, activation: 'relu' }, { type: 'pool', sx: 2, stride: 2 }, { type: 'conv', sx: 5, filters: 20, stride: 1, pad: 2, activation: 'relu' }, { type: 'pool', sx: 2, stride: 2 }, { type: 'softmax', num_classes: 10 }]);
...
/***/ function(module, exports) {
	...
	(function (global) {
	  ...
	  var arrContains = function arrContains(arr, elt) {
	  ...
	  var randperm = function randperm(n) {
	    var i = n,
	        j = 0,
	        temp;
	    var array = [];
	  ...
	  var weightedSample = function weightedSample(lst, probs) {
	    var p = randf(0, 1.0);
	    var cumprob = 0.0;
	  ...
	  var getopt = function getopt(opt, field_name, default_value) {
	...
	(function (global) {
	  ...
	  var Vol = function Vol(sx, sy, depth, c) {
	  ...
	  Vol.prototype = {
	    get: function get(x, y, d) {
	      var ix = (this.sx * y + x) * this.depth + d;
	      return this.w[ix];
	    },
	    set: function set(x, y, d, v) {
	      var ix = (this.sx * y + x) * this.depth + d;
	      this.w[ix] = v;
	    },
	    add: function add(x, y, d, v) {
	      var ix = (this.sx * y + x) * this.depth + d;
	      this.w[ix] += v;
	    },
	    get_grad: function get_grad(x, y, d) {
	      var ix = (this.sx * y + x) * this.depth + d;
	      return this.dw[ix];
	    },
	    set_grad: function set_grad(x, y, d, v) {
	      var ix = (this.sx * y + x) * this.depth + d;
	      this.dw[ix] = v;
	    },
	    add_grad: function add_grad(x, y, d, v) {
	      var ix = (this.sx * y + x) * this.depth + d;
	      this.dw[ix] += v;
	    },
	    cloneAndZero: function cloneAndZero() {
	    ...
	    addFrom: function addFrom(V) {
	      for (var k = 0; k < this.w.length; k++) {
	        this.w[k] += V.w[k];
	      }
	    },
	    addFromScaled: function addFromScaled(V, a) {
	      for (var k = 0; k < this.w.length; k++) {
	        this.w[k] += a * V.w[k];
	      }
	    },
	    setConst: function setConst(a) {
	      for (var k = 0; k < this.w.length; k++) {
	        this.w[k] = a;
	      }
	    },
	...
	(function (global) {
	  ...
	  var augment = function augment(V, crop, dx, dy, fliplr) {
	  ...
	  var img_to_vol = function img_to_vol(img, convert_grayscale) {
	  ...
	  var ConvLayer = function ConvLayer(opt) {
	    var opt = opt || {};
	  ...
	  ConvLayer.prototype = {
	    forward: function forward(V, is_training) {
	    ...
	    getParamsAndGrads: function getParamsAndGrads() {
	      var response = [];
	      for (var i = 0; i < this.out_depth; i++) {
	  ...
	  var FullyConnLayer = function FullyConnLayer(opt) {
	    var opt = opt || {};
	...
	(function (global) {
	  ...
	  var PoolLayer = function PoolLayer(opt) {
	...
	(function (global) {
	  ...
	  var InputLayer = function InputLayer(opt) {
	    var opt = opt || {};
	...
	(function (global) {
	  ...
	  var SoftmaxLayer = function SoftmaxLayer(opt) {
	    var opt = opt || {};
	  ...
	  var RegressionLayer = function RegressionLayer(opt) {
	    var opt = opt || {};
	  ...
	  var SVMLayer = function SVMLayer(opt) {
	    var opt = opt || {};
	...
	(function (global) {
	  ...
	  var ReluLayer = function ReluLayer(opt) {
	    var opt = opt || {};
	  ...
	  var SigmoidLayer = function SigmoidLayer(opt) {
	    var opt = opt || {};
	  ...
	  var MaxoutLayer = function MaxoutLayer(opt) {
	    var opt = opt || {};
	  ...
	  var TanhLayer = function TanhLayer(opt) {
	    var opt = opt || {};
	...
	(function (global) {
	  ...
	  var DropoutLayer = function DropoutLayer(opt) {
	    var opt = opt || {};
	...
	(function (global) {
	  ...
	  var LocalResponseNormalizationLayer = function LocalResponseNormalizationLayer(opt) {
	    var opt = opt || {};
	...
	(function (global) {
	  ...
	  Net.prototype = {
	    ...
	    makeLayers: function makeLayers(defs) {
	      ...
	      for (var i = 0; i < defs.length; i++) {
	        ...
	        switch (def.type) {
	          case 'fc':
	            this.layers.push(new global.FullyConnLayer(def));break;
	          case 'lrn':
	            this.layers.push(new global.LocalResponseNormalizationLayer(def));break;
	          case 'dropout':
	            this.layers.push(new global.DropoutLayer(def));break;
	          case 'input':
	            this.layers.push(new global.InputLayer(def));break;
	          case 'softmax':
	            this.layers.push(new global.SoftmaxLayer(def));break;
	          case 'regression':
	            this.layers.push(new global.RegressionLayer(def));break;
	          case 'conv':
	            this.layers.push(new global.ConvLayer(def));break;
	          case 'pool':
	            this.layers.push(new global.PoolLayer(def));break;
	          case 'relu':
	            this.layers.push(new global.ReluLayer(def));break;
	          case 'sigmoid':
	            this.layers.push(new global.SigmoidLayer(def));break;
	          case 'tanh':
	            this.layers.push(new global.TanhLayer(def));break;
	          case 'maxout':
	            this.layers.push(new global.MaxoutLayer(def));break;
	          case 'svm':
	            this.layers.push(new global.SVMLayer(def));break;
	          default:
	    ...
	    getCostLoss: function getCostLoss(V, y) {
	...
	(function (global) {
	  ...
	  var Trainer = function Trainer(net, options) {
	...
	(function (global) {
	  ...
	  */
	  var MagicNet = function MagicNet(data, labels, opt) {
	    var opt = opt || {};
	  ...
	  MagicNet.prototype = {
	    ...
	    sampleFolds: function sampleFolds() {
	    ...
	    sampleCandidate: function sampleCandidate() {
	    ...
	    sampleCandidates: function sampleCandidates() {
	    ...
	    evalValErrors: function evalValErrors() {
	    ...
	    // x is a Vol.
	    predict_soft: function predict_soft(data) {
	    ...
	    onFinishFold: function onFinishFold(f) {
	      this.finish_fold_callback = f;
	    },
	    // called when a batch of candidates has finished evaluating
	    onFinishBatch: function onFinishBatch(f) {
...
/***/ function(module, exports) {
	...
	(function (global) {
	  ...
	  var Experience = function Experience(state0, action0, reward0, state1) {
	    this.state0 = state0;
	  ...
	  var Brain = function Brain(num_states, num_actions, opt) {
	    var opt = opt || {};
	  ...
	  Brain.prototype = {
	    random_action: function random_action() {
	    ...
	    getNetInput: function getNetInput(xt) {
	    ...
	    forward: function forward(input_array) {
	    ...
	    backward: function backward(reward) {
